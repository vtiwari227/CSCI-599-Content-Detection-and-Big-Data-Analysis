 ...
 * {@link OpenNLPNameFinder}s for which NER models are available in classpath.
 *
 ...
 */
public class OpenNLPNERRecogniser implements NERecogniser {
//"C:\\Users\\Snehal\\Documents\\NetBeansProjects\\TIKANERSweet\\model";
    public static String MODELS_DIR= OpenNLPNERRecogniser.class.getPackage().getName().replace(".", "/");
    ...
    public static String NER_PERSON_MODEL = MODELS_DIR + "\\" + PERSON_FILE;
    public static String NER_LOCATION_MODEL = MODELS_DIR + "\\" + LOCATION_FILE;
    public static String NER_ORGANIZATION_MODEL = MODELS_DIR + "\\" + ORGANIZATION_FILE;
    public static String NER_TIME_MODEL = MODELS_DIR + "\\" + TIME_FILE;
    public static String NER_DATE_MODEL = MODELS_DIR + "\\" + DATE_FILE;
    public static String NER_PERCENT_MODEL = MODELS_DIR + "\\" + PERCENT_FILE;
    public static String NER_MONEY_MODEL = MODELS_DIR + "\\" + MONEY_FILE;

    public static Map<String, String> DEFAULT_MODELS
     ...
     *
     * @param models map of entityType -> model path NOTE: the model path should
     * be known to class loader.
     */
    public OpenNLPNERRecogniser(Map<String, String> models) {
        try {
     ...
     public static OpenNLPNERRecogniser instanceOpenNLPNERRecogniser(String modelPath) {
        MODELS_DIR = modelPath;
        NER_PERSON_MODEL = MODELS_DIR + "\\" + PERSON_FILE;
        NER_LOCATION_MODEL = MODELS_DIR + "\\" + LOCATION_FILE;
        NER_ORGANIZATION_MODEL = MODELS_DIR + "\\" + ORGANIZATION_FILE;
        NER_TIME_MODEL = MODELS_DIR + "\\" + TIME_FILE;
        NER_DATE_MODEL = MODELS_DIR + "\\" + DATE_FILE;
        NER_PERCENT_MODEL = MODELS_DIR + "\\" + PERCENT_FILE;
        NER_MONEY_MODEL = MODELS_DIR + "\\" + MONEY_FILE;
        DEFAULT_MODELS
                = new HashMap<String, String>() {
                    {
                        put(PERSON, NER_PERSON_MODEL);
     ...
     return   new OpenNLPNERRecogniser();
    //new OpenNLPNERRecogniser();
    }
